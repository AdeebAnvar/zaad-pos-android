      ...
      builder: (context, state) {
        ...
        if (state is SaleLoadedState) {
          return LayoutBuilder(builder: (ctx, con) {
            return AppResponsive.isDesktop(ctx)
                ? desktopView(categories: state.categories, products: state.products)
                : mobileView(categories: state.categories, products: state.products);
          });
        } else {
          return Center(
              child: Column(
  ...
  Widget desktopView({
    ...
    return Row(
      children: [
        ...
        Expanded(child: mobileView(categories: categories, products: products)),
      ],
    );
  }
